...
public class TodoDAO {
     ...
     */
    public void insertTodo(int todoId, String userId, String title, String detail, char done, Date date) {
        String sql = "INSERT INTO TODO (todo_id, id, todoTitle, todoDetail, todoYn, date) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            stmt.setString(5, String.valueOf(done));
            stmt.setDate(6, date);
